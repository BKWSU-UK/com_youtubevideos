 ...
 * @since  1.0.0
 */
class PlaylistTable extends Table implements VersionableTableInterface
{
    /**
     * Constructor
     *
    ...
    {
        $this->typeAlias = 'com_youtubevideos.playlist';

        parent::__construct('#__youtubevideos_playlists', 'id', $db, $dispatcher);
    ...
    public function check()
    {
        ...
        // Check for valid youtube_playlist_id
        if (trim($this->youtube_playlist_id) == '') {
            $this->setError(Text::_('COM_YOUTUBEVIDEOS_WARNING_PROVIDE_VALID_PLAYLIST_ID'));
            return false;
        }
