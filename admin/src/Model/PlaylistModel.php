...
class PlaylistModel extends AdminModel
{
     ...
     * @since  1.0.0
     */
    public $typeAlias = 'com_youtubevideos.playlist';
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_youtubevideos.edit.playlist.data', []);

        if (empty($data)) {
            $data = $this->getItem();
        }

        $this->preprocessData('com_youtubevideos.playlist', $data);
     ...
     * @throws  \Exception
     */
    public function getTable($type = 'Playlist', $prefix = 'Administrator', $config = [])
    {
     ...
     * @since   1.0.0
     */
    protected function generateNewTitle($playlistId, $alias, $title)
    {
        $table = $this->getTable();
