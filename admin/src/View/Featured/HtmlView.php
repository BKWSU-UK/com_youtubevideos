<?php
namespace BKWSU\Component\Youtubevideos\Administrator\View\Featured;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolbar(): void
    {
        ...
        ToolbarHelper::title(Text::_('COM_YOUTUBEVIDEOS_FEATURED_TITLE'), 'star');
        ...
        if ($canDo->get('core.edit.state'))
        {
            ...
            $childBar->publish('featured.publish')->listCheck(true);
            $childBar->unpublish('featured.unpublish')->listCheck(true);
            ...
            $childBar->standardButton('unfeatured')
                ...
                ->task('featured.unfeatured')
                ->listCheck(true);

            if ($canDo->get('core.admin'))
            {
                $childBar->checkin('featured.checkin')->listCheck(true);
            }

            if ($this->state->get('filter.published') == -2 && $canDo->get('core.delete'))
            {
                $toolbar->delete('featured.delete')
            ...
            {
                $childBar->trash('featured.trash')->listCheck(true);
            }
        }
