...
/** @var \BKWSU\Component\Youtubevideos\Administrator\View\Featured\HtmlView $this */
...
{
    $saveOrderingUrl = 'index.php?option=com_youtubevideos&task=featured.saveOrderAjax&tmpl=component&' . Session::getFormToken() . '=1';
...
?>
<form action="<?php echo Route::_('index.php?option=com_youtubevideos&view=featured'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    <table class="table table-striped" id="videoList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_YOUTUBEVIDEOS_FEATURED_TABLE_CAPTION'); ?>,
                        ...
                        <?php foreach ($this->items as $i => $item) :
                            ...
                            <tr class="row<?php echo $i % 2; ?>" data-draggable-group="0">
                                ...
                                <td class="text-center">
                                    <?php echo HTMLHelper::_('jgrid.published', $item->published, $i, 'featured.', $canChange, 'cb'); ?>
                                </td>
                                <td class="text-center">
                                    <?php echo HTMLHelper::_('jgrid.state', $featuredStates, $item->featured, $i, 'featured.', $canChange); ?>
                                </td>
                                <th scope="row" class="has-context">
                                    <div>
                                        <?php if ($item->checked_out) : ?>
                                            <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'featured.', $canCheckin); ?>
                                        <?php endif; ?>
